...
#s(hash-table test equal data ("straight" ("2026-05-20 13:20:53" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "main" :package "straight" :local-repo "straight.el")) "org-elpa" ("2026-05-20 13:20:53" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2026-05-20 13:20:53" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2026-05-20 13:20:53" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2026-05-20 13:20:53" nil (:type git :repo "https://github.com/emacsmirror/nongnu_elpa.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2026-05-20 13:20:53" nil (:type git :host github :repo "dimitri/el-get" :build nil :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2026-05-20 13:20:53" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "use-package" ("2026-05-20 13:20:53" ("emacs" "bind-key") (:type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git")) :package "use-package" :local-repo "use-package")) "bind-key" ("2026-05-20 13:20:53" ("emacs") (:type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git")) :package "bind-key" :local-repo "bind-key")) "exec-path-from-shell" ("2026-05-20 13:20:54" ("emacs") (:type git :host github :repo "purcell/exec-path-from-shell" :package "exec-path-from-shell" :local-repo "exec-path-from-shell")) "general" ("2026-05-20 13:20:54" ("emacs" "cl-lib") (:type git :host github :repo "noctuid/general.el" :package "general" :local-repo "general.el")) "which-key" ("2026-05-20 13:20:54" ("emacs") (:type git :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "catppuccin-theme" ("2026-05-20 13:20:54" ("emacs") (:type git :host github :repo "catppuccin/emacs" :package "catppuccin-theme" :local-repo "emacs")) "doom-modeline" ("2026-05-20 13:20:56" ("emacs" "compat" "nerd-icons" "shrink-path") (:type git :host github :repo "seagle0128/doom-modeline" :package "doom-modeline" :local-repo "doom-modeline")) "compat" ("2026-05-20 13:20:55" ("emacs") (:type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git")) :package "compat" :local-repo "compat")) "nerd-icons" ("2026-05-20 13:20:55" ("emacs") (:type git :files (:defaults "data" "nerd-icons-pkg.el") :host github :repo "rainstormstudio/nerd-icons.el" :package "nerd-icons" :local-repo "nerd-icons.el")) "shrink-path" ("2026-05-20 13:20:56" ("emacs" "s" "dash" "f") (:type git :host gitlab :repo "bennya/shrink-path.el" :package "shrink-path" :local-repo "shrink-path.el")) "s" ("2026-05-20 13:20:55" nil (:type git :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "dash" ("2026-05-20 13:20:55" nil (:type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "f" ("2026-05-20 13:20:56" ("emacs" "s" "dash") (:type git :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "nyan-mode" ("2026-05-20 13:20:57" ("emacs") (:type git :files ("nyan-mode.el" "img" "mus" "nyan-mode-pkg.el") :host github :repo "TeMPOraL/nyan-mode" :package "nyan-mode" :local-repo "nyan-mode")) "evil" ("2026-05-20 13:21:03" ("emacs" "cl-lib" "goto-chg" "nadvice") (:type git :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil" :package "evil" :local-repo "evil")) "goto-chg" ("2026-05-20 13:21:02" ("emacs") (:type git :host github :repo "emacs-evil/goto-chg" :package "goto-chg" :local-repo "goto-chg")) "evil-collection" ("2026-05-20 13:21:06" ("emacs" "evil" "annalist") (:type git :files (:defaults "modes" "evil-collection-pkg.el") :host github :repo "emacs-evil/evil-collection" :package "evil-collection" :local-repo "evil-collection")) "annalist" ("2026-05-20 13:21:05" ("emacs" "cl-lib") (:type git :host github :repo "noctuid/annalist.el" :package "annalist" :local-repo "annalist.el")) "evil-nerd-commenter" ("2026-05-20 13:21:07" ("emacs") (:type git :host github :repo "redguardtoo/evil-nerd-commenter" :package "evil-nerd-commenter" :local-repo "evil-nerd-commenter")) "projectile" ("2026-05-20 13:21:10" ("emacs" "compat") (:type git :host github :repo "bbatsov/projectile" :package "projectile" :local-repo "projectile")) "magit" ("2026-05-20 13:21:19" ("emacs" "compat" "cond-let" "llama" "magit-section" "seq" "transient" "with-editor") (:type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" ("git-hooks" "git-hooks/*") (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit" :package "magit" :local-repo "magit")) "cond-let" ("2026-05-20 13:21:15" ("emacs") (:type git :host github :repo "tarsius/cond-let" :package "cond-let" :local-repo "cond-let")) "llama" ("2026-05-20 13:21:15" ("emacs" "compat") (:type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama" :package "llama" :local-repo "llama")) "magit-section" ("2026-05-20 13:21:16" ("emacs" "compat" "cond-let" "llama" "seq") (:files ("lisp/magit-section.el" "docs/magit-section.texi" "magit-section-pkg.el" "magit-section-pkg.el") :package "magit-section" :local-repo "magit" :type git :repo "magit/magit" :host github)) "seq" ("2026-05-20 13:21:16" nil (:type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git")) :package "seq" :local-repo "seq")) "transient" ("2026-05-20 13:21:18" ("emacs" "compat" "cond-let" "seq") (:type git :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2026-05-20 13:21:18" ("emacs" "compat" "cond-let") (:type git :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "diff-hl" ("2026-05-20 13:21:22" ("cl-lib" "emacs") (:type git :host github :repo "dgutov/diff-hl" :package "diff-hl" :local-repo "diff-hl")) "vterm" ("2026-05-20 13:21:23" ("emacs") (:type git :files ("CMakeLists.txt" "elisp.c" "elisp.h" "emacs-module.h" "etc" "utf8.c" "utf8.h" "vterm.el" "vterm-module.c" "vterm-module.h" "vterm-pkg.el") :host github :repo "akermu/emacs-libvterm" :package "vterm" :local-repo "emacs-libvterm")) "vterm-toggle" ("2026-05-20 13:21:24" ("emacs" "vterm") (:type git :host github :repo "jixiuf/vterm-toggle" :package "vterm-toggle" :local-repo "vterm-toggle")) "rg" ("2026-05-20 13:21:25" ("emacs" "transient" "wgrep") (:type git :host github :repo "dajva/rg.el" :package "rg" :local-repo "rg.el")) "wgrep" ("2026-05-20 13:21:25" ("emacs") (:type git :files ("wgrep.el" "wgrep-pkg.el") :host github :repo "mhayashi1120/Emacs-wgrep" :package "wgrep" :local-repo "Emacs-wgrep")) "gcmh" ("2026-05-20 13:21:26" ("emacs") (:type git :host gitlab :repo "koral/gcmh" :package "gcmh" :local-repo "gcmh")) "eglot" ("2026-05-20 13:21:32" ("emacs" "eldoc" "external-completion" "flymake" "jsonrpc" "project" "seq" "xref") (:type git :host github :repo "emacs-straight/eglot" :files ("*" (:exclude ".git")) :package "eglot" :local-repo "eglot")) "eldoc" ("2026-05-20 13:21:28" ("emacs") (:type git :host github :repo "emacs-straight/eldoc" :files ("*" (:exclude ".git")) :package "eldoc" :local-repo "eldoc")) "external-completion" ("2026-05-20 13:21:29" ("emacs") (:type git :host github :repo "emacs-straight/external-completion" :files ("*" (:exclude ".git")) :package "external-completion" :local-repo "external-completion")) "flymake" ("2026-05-20 13:21:31" ("emacs" "eldoc" "project") (:type git :host github :repo "emacs-straight/flymake" :files ("*" (:exclude ".git")) :package "flymake" :local-repo "flymake")) "project" ("2026-05-20 13:21:31" ("emacs" "xref") (:type git :host github :repo "emacs-straight/project" :files ("*" (:exclude ".git")) :package "project" :local-repo "project")) "xref" ("2026-05-20 13:21:31" ("emacs") (:type git :host github :repo "emacs-straight/xref" :files ("*" (:exclude ".git")) :package "xref" :local-repo "xref")) "jsonrpc" ("2026-05-20 13:21:32" ("emacs") (:type git :host github :repo "emacs-straight/jsonrpc" :files ("*" (:exclude ".git")) :package "jsonrpc" :local-repo "jsonrpc")) "flycheck" ("2026-05-20 13:21:36" ("emacs" "seq") (:type git :host github :repo "flycheck/flycheck" :package "flycheck" :local-repo "flycheck")) "treesit-auto" ("2026-05-20 13:21:37" ("emacs") (:type git :host github :repo "renzmann/treesit-auto" :package "treesit-auto" :local-repo "treesit-auto")) "ivy" ("2026-05-20 13:21:39" ("emacs") (:type git :files (:defaults "doc/ivy-help.org" (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "ivy-pkg.el") :host github :repo "abo-abo/swiper" :package "ivy" :local-repo "swiper")) "company" ("2026-05-20 13:21:42" ("emacs" "posframe") (:type git :files (:defaults "icons" ("images/small" "doc/images/small/*.png") "company-pkg.el") :host github :repo "company-mode/company-mode" :package "company" :local-repo "company-mode")) "posframe" ("2026-05-20 13:21:41" ("emacs") (:type git :host github :repo "tumashu/posframe" :package "posframe" :local-repo "posframe")) "treemacs" ("2026-05-20 13:21:48" ("emacs" "cl-lib" "dash" "s" "ace-window" "pfuture" "hydra" "ht" "cfrs") (:type git :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs" :package "treemacs" :local-repo "treemacs")) "ace-window" ("2026-05-20 13:21:45" ("avy") (:type git :host github :repo "abo-abo/ace-window" :package "ace-window" :local-repo "ace-window")) "avy" ("2026-05-20 13:21:45" ("emacs" "cl-lib") (:type git :host github :repo "abo-abo/avy" :package "avy" :local-repo "avy")) "pfuture" ("2026-05-20 13:21:46" ("emacs") (:type git :host github :repo "Alexander-Miller/pfuture" :package "pfuture" :local-repo "pfuture")) "hydra" ("2026-05-20 13:21:47" ("cl-lib" "lv") (:type git :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra" :package "hydra" :local-repo "hydra")) "lv" ("2026-05-20 13:21:46" nil (:files ("lv.el" "lv-pkg.el") :package "lv" :local-repo "hydra" :type git :repo "abo-abo/hydra" :host github)) "ht" ("2026-05-20 13:21:47" ("dash") (:type git :host github :repo "Wilfred/ht.el" :package "ht" :local-repo "ht.el")) "cfrs" ("2026-05-20 13:21:48" ("emacs" "dash" "s" "posframe") (:type git :host github :repo "Alexander-Miller/cfrs" :package "cfrs" :local-repo "cfrs")) "treemacs-projectile" ("2026-05-20 13:21:48" ("emacs" "projectile" "treemacs") (:files ("src/extra/treemacs-projectile.el" "treemacs-projectile-pkg.el") :package "treemacs-projectile" :local-repo "treemacs" :type git :repo "Alexander-Miller/treemacs" :host github)) "dashboard" ("2026-05-20 13:21:49" ("emacs") (:type git :files (:defaults "banners" "dashboard-pkg.el") :host github :repo "emacs-dashboard/dashboard" :package "dashboard" :local-repo "dashboard")) "all-the-icons" ("2026-05-20 13:21:52" ("emacs") (:type git :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el" :package "all-the-icons" :local-repo "all-the-icons.el")) "awesome-tab" ("2026-05-20 13:21:53" nil (:type git :host github :repo "emacsmirror/awesome-tab" :package "awesome-tab" :local-repo "awesome-tab")) "scroll-restore" ("2026-05-20 13:21:54" nil (:type git :host github :repo "emacs-straight/scroll-restore" :files ("*" (:exclude ".git")) :package "scroll-restore" :local-repo "scroll-restore"))))

#s(hash-table test equal data ("straight" ((straight-ert-print-hack straight straight-autoloads straight-x) (autoload 'straight-remove-unused-repos "straight" "Remove unused repositories from the repos and build directories.
...
(fn &rest ARGS)" nil t) (autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t) (register-definition-prefixes "bind-key" '("bind-key" "override-global-m")) (provide 'bind-key-autoloads)) "use-package" ((use-package-pkg use-package-ensure-system-package use-package-core use-package-autoloads use-package-diminish use-package use-package-bind-key use-package-lint use-package-delight use-package-jump use-package-ensure) (autoload 'use-package-autoload-keymap "use-package-bind-key" "Load PACKAGE and bind key sequence invoking this function to KEYMAP-SYMBOL.
...
values used in the user's shell." t) (register-definition-prefixes "exec-path-from-shell" '("exec-path-from-shell-")) (provide 'exec-path-from-shell-autoloads)) "general" ((general general-autoloads) (autoload 'general-define-key "general" "The primary key definition function provided by general.el.
...
(fn &optional SHORT-NAMES _)") (register-definition-prefixes "general" '("general-")) (provide 'general-autoloads)) "which-key" ((which-key which-key-autoloads) (defvar which-key-mode nil "Non-nil if Which-Key mode is enabled.
...
KEYMAP is selected interactively by mode in
`minor-mode-map-alist'." t) (register-definition-prefixes "which-key" '("evil-state" "which-key-")) (provide 'which-key-autoloads)) "catppuccin-theme" ((catppuccin-theme catppuccin-theme-autoloads catppuccin-definitions) (when load-file-name (add-to-list 'custom-theme-load-path (file-name-as-directory (file-name-directory load-file-name)))) (register-definition-prefixes "catppuccin-theme" '("catppuccin-" "define-catppuccin-flavor")) (provide 'catppuccin-theme-autoloads)) "compat" ((compat-27 compat-30 compat-29 compat-pkg compat-macs compat-autoloads compat-31 compat-26 compat compat-28) (register-definition-prefixes "compat" '("compat-")) (register-definition-prefixes "compat-macs" '("compat-")) (provide 'compat-autoloads)) "nerd-icons" ((nerd-icons nerd-icons-faces nerd-icons-data nerd-icons-autoloads) (autoload 'nerd-icons-install-fonts "nerd-icons" "Helper function to download and install the latests fonts based on OS.
...
(fn &rest ARG-OVERRIDES)") (register-definition-prefixes "nerd-icons" '("nerd-icons-")) (provide 'nerd-icons-autoloads)) "s" ((s-autoloads s) (register-definition-prefixes "s" '("s-")) (provide 's-autoloads)) "dash" (nil) "f" ((f-shortdoc f f-autoloads) (register-definition-prefixes "f" '("f-")) (provide 'f-autoloads)) "shrink-path" ((shrink-path-autoloads shrink-path) (register-definition-prefixes "shrink-path" '("shrink-path-")) (provide 'shrink-path-autoloads)) "doom-modeline" ((doom-modeline doom-modeline-segments doom-modeline-env doom-modeline-autoloads doom-modeline-core) (autoload 'doom-modeline-set-main-modeline "doom-modeline" "Set main mode-line.
...
(fn &optional ARG)" t) (register-definition-prefixes "nyan-mode" '("nyan-")) (provide 'nyan-mode-autoloads)) "goto-chg" ((goto-chg-autoloads goto-chg) (autoload 'goto-last-change "goto-chg" "Go to the point where the last edit was made in the current buffer.
...
(fn &optional MODES)" t) (register-definition-prefixes "evil-collection" '("evil-collection-")) (provide 'evil-collection-autoloads)) "evil-nerd-commenter" ((evil-nerd-commenter-sdk evil-nerd-commenter-operator evil-nerd-commenter evil-nerd-commenter-autoloads) (autoload 'evilnc-comment-or-uncomment-region-internal "evil-nerd-commenter" "Comment or uncomment region from START to END.
...
(fn PROMPT)" t) (autoload 'projectile-discard-root-cache "projectile" "Clear `projectile-project-root-cache' without touching other caches.
...
the per-project file list and project-type caches." t) (autoload 'projectile-purge-file-from-cache "projectile" "Purge FILE from the cache of the current project.
...
(fn &optional INVALIDATE-CACHE)" t) (autoload 'projectile-find-file-all "projectile" "Jump to any file in the project, ignoring VCS and projectile ignore rules.
...
ignore mechanisms." t) (autoload 'projectile-toggle-project-read-only "projectile" "Toggle project read only." t) (autoload 'projectile-add-dir-local-variable "projectile" "Run `add-dir-local-variable' with .dir-locals.el in root of project.
...
`projectile-kill-buffers-filter'." t) (autoload 'projectile-save-project-buffers "projectile" "Save all project buffers." t) (autoload 'projectile-dired "projectile" "Open `dired' at the root of the project.
With a prefix argument ARG, prompt for a known project to open in dired.

(fn &optional ARG)" t) (autoload 'projectile-dired-other-window "projectile" "Open `dired' at the root of the project in another window.
With a prefix argument ARG, prompt for a known project to open in dired.

(fn &optional ARG)" t) (autoload 'projectile-dired-other-frame "projectile" "Open `dired' at the root of the project in another frame.
With a prefix argument ARG, prompt for a known project to open in dired.

(fn &optional ARG)" t) (autoload 'projectile-vc "projectile" "Open `vc-dir' at the root of the project.
...
(fn &optional ARG)" t) (define-obsolete-function-alias 'projectile-global-mode 'projectile-mode "1.0") (register-definition-prefixes "projectile" '("compilation-find-file-projectile-find-compilation-buffer" "def-projectile-commander-method" "delete-file-projectile-remove-from-cache" "projectile-" "savehist-additional-variables")) (provide 'projectile-autoloads)) "cond-let" ((cond-let-autoloads cond-let) (register-definition-prefixes "cond-let" '("cond-let")) (provide 'cond-let-autoloads)) "llama" ((llama-autoloads llama \.dir-locals) (autoload 'llama "llama" "Expand to a `lambda' expression that wraps around FN and BODY.
...
(fn &optional ARG)" t) (register-definition-prefixes "llama" '("##" "all-completions" "elisp-" "intern" "lisp--el-match-keyword@llama" "llama-")) (provide 'llama-autoloads)) "seq" ((seq-25 seq-pkg seq-autoloads seq seq-24) (register-definition-prefixes "seq-24" '("seq")) (autoload 'seq-subseq "seq-25" "Return the sequence of elements of SEQUENCE from START to END.
END is exclusive.
...
(fn SEQUENCE)") (register-definition-prefixes "seq-25" '("seq-")) (provide 'seq-autoloads)) "magit-section" ((magit-section-autoloads magit-section) (autoload 'magit-add-section-hook "magit-section" "Add to the value of section hook HOOK the function FUNCTION.
...
(fn COMMAND &optional OUTPUT-BUFFER ERROR-BUFFER ENVVAR)" t) (register-definition-prefixes "with-editor" '("server-" "shell-command" "start-file-process" "with-editor")) (provide 'with-editor-autoloads)) "magit" ((magit-transient magit-extras magit-worktree magit-dired magit-clone magit-blame magit-push magit-remote magit-commit magit-sparse-checkout magit-ediff magit-repos magit-margin magit-gitignore magit-fetch magit-bisect magit-submodule magit-tag magit-notes magit-process magit-merge magit-refs magit-git magit-branch magit-reflog magit-autorevert magit-stash magit-bookmark magit-wip magit-status magit-patch magit-autoloads magit-mode magit-diff magit-pull magit-apply magit git-commit magit-log magit-files magit-base magit-subtree magit-core magit-bundle magit-sequence magit-reset git-rebase \.dir-locals) (put 'git-commit-major-mode 'safe-local-variable (lambda (val) (memq val '(text-mode markdown-mode org-mode fundamental-mode log-edit-mode git-commit-elisp-text-mode)))) (autoload 'git-commit-insert-changelog-gnu "git-commit" "Insert a GNU-style changelog at point while authorig a commit message.
...
(fn WORKTREE DIRECTORY)" t) (register-definition-prefixes "magit-worktree" '("magit-")) (provide 'magit-autoloads)) "diff-hl" ((diff-hl-autoloads diff-hl-show-hunk diff-hl-margin diff-hl-show-hunk-posframe diff-hl-amend diff-hl-flydiff diff-hl-show-hunk-inline diff-hl diff-hl-dired) (autoload 'diff-hl-mode "diff-hl" "Toggle VC diff highlighting.
...
(fn REV)" t) (autoload 'diff-hl-set-reference-rev-in-project "diff-hl" "Set the reference revision in the current project to REV.
When called interactively, REV read with completion.
...
(fn REV)" t) (autoload 'diff-hl-reset-reference-rev "diff-hl" "Reset the reference revision globally to the most recent one.
...
(fn &optional ARG)" t) (put 'global-diff-hl-mode 'globalized-minor-mode t) (defvar global-diff-hl-mode nil "Non-nil if Global Diff-Hl mode is enabled.
...
(fn &optional ARG)" t) (register-definition-prefixes "diff-hl" '("diff-hl-" "static-if")) (autoload 'diff-hl-amend-mode "diff-hl-amend" "Show changes against the second-last revision in `diff-hl-mode'.
...
(fn &optional ARG)" t) (autoload 'diff-hl-dired-mode-unless-remote "diff-hl-dired") (register-definition-prefixes "diff-hl-dired" '("diff-hl-dir")) (defvar diff-hl-flydiff-mode nil "Non-nil if Diff-Hl-Flydiff mode is enabled.
...
(fn &optional ARG)" t) (register-definition-prefixes "diff-hl-flydiff" '("diff-hl-flydiff")) (defvar diff-hl-margin-mode nil "Non-nil if Diff-Hl-Margin mode is enabled.
...
(fn &optional ARG)" t) (register-definition-prefixes "diff-hl-margin" '("diff-hl-")) (autoload 'diff-hl-show-hunk-previous "diff-hl-show-hunk" "Go to previous hunk/change and show it." t) (autoload 'diff-hl-show-hunk-next "diff-hl-show-hunk" "Go to next hunk/change and show it." t) (autoload 'diff-hl-show-hunk "diff-hl-show-hunk" "Show the VC diff hunk at point.
...
(fn &optional ARG)" t) (register-definition-prefixes "diff-hl-show-hunk" '("diff-hl-show-hunk-")) (autoload 'diff-hl-show-hunk-inline-hide "diff-hl-show-hunk-inline" "Hide the current inline popup." t) (autoload 'diff-hl-show-hunk-inline-show "diff-hl-show-hunk-inline" "Create a phantom overlay to show the inline popup, with some
...
(fn LINES &optional HEADER FOOTER KEYMAP CLOSE-HOOK POINT HEIGHT)") (autoload 'diff-hl-show-hunk-inline "diff-hl-show-hunk-inline" "Implementation to show the hunk in a inline popup.
BUFFER is a buffer with the hunk.

(fn BUFFER &optional IGNORED-LINE)") (register-definition-prefixes "diff-hl-show-hunk-inline" '("diff-hl-show-hunk-inline-")) (autoload 'diff-hl-show-hunk-posframe "diff-hl-show-hunk-posframe" "Implementation to show the hunk in a posframe.

(fn BUFFER &optional LINE)") (register-definition-prefixes "diff-hl-show-hunk-posframe" '("diff-hl-show-hunk-")) (provide 'diff-hl-autoloads)) "vterm" ((vterm-autoloads vterm) (autoload 'vterm-module-compile "vterm" "Compile vterm-module." t) (autoload 'vterm--bookmark-handler "vterm" "Handler to restore a vterm bookmark BMK.
...
(fn &optional ARG)" t) (register-definition-prefixes "vterm" '("vterm-")) (provide 'vterm-autoloads)) "vterm-toggle" ((vterm-toggle vterm-toggle-autoloads) (autoload 'vterm-toggle "vterm-toggle" "Vterm toggle.
...
(fn &optional OFFSET)" t) (register-definition-prefixes "vterm-toggle" '("vterm-")) (provide 'vterm-toggle-autoloads)) "wgrep" ((wgrep wgrep-autoloads) (autoload 'wgrep-setup "wgrep" "Setup wgrep preparation.") (add-hook 'grep-setup-hook 'wgrep-setup) (register-definition-prefixes "wgrep" '("wgrep-")) (provide 'wgrep-autoloads)) "rg" ((rg-menu rg-ibuffer rg-result rg-header rg-isearch rg-autoloads rg rg-info-hack wgrep-rg rg-history) (defvar rg-keymap-prefix "s" "Prefix for global `rg' keymap.") (custom-autoload 'rg-keymap-prefix "rg" t) (defvar rg-command-line-flags-function 'identity "Function to modify command line flags of a search.
...
(fn &optional PREFIX)" t) (autoload 'rg-use-old-defaults "rg" "Restore default settings pre version 2.0.0.") (autoload 'rg-define-search "rg" "Define an rg search functions named NAME.
...
(fn &optional CURDIR)" t) (autoload 'rg-literal "rg.el" "" t) (autoload 'rg "rg.el" "" t) (register-definition-prefixes "rg" '("kill-rg" "rg-")) (register-definition-prefixes "rg-header" '("rg-")) (register-definition-prefixes "rg-history" '("rg-history-")) (autoload 'rg-list-searches "rg-ibuffer" "List all `rg-mode' buffers in `ibuffer'." t) (register-definition-prefixes "rg-ibuffer" '("rg-")) (register-definition-prefixes "rg-info-hack" '("info-insert-file-contents")) (autoload 'rg-isearch-current-file "rg-isearch.el" "" t) (autoload 'rg-isearch-current-dir "rg-isearch.el" "" t) (autoload 'rg-isearch-project "rg-isearch.el" "" t) (autoload 'rg-isearch-menu "rg-isearch.el" "" t) (register-definition-prefixes "rg-isearch" '("rg-get-isearch-string")) (autoload 'rg-menu "rg-menu.el" "" t) (autoload 'rg-enable-menu "rg-menu" "Bind `rg-menu' to PREFIX key.
If prefix is not supplied `rg-keymap-prefix' is used.

(fn &optional PREFIX)" t) (register-definition-prefixes "rg-menu" '("rg-menu-")) (register-definition-prefixes "rg-result" '("rg-")) (autoload 'wgrep-rg-setup "wgrep-rg" "Setup wgrep rg support.") (add-hook 'rg-mode-hook 'wgrep-rg-setup) (register-definition-prefixes "wgrep-rg" '("wgrep-rg-")) (provide 'rg-autoloads)) "gcmh" ((gcmh gcmh-autoloads) (defvar gcmh-mode nil "Non-nil if GCMH mode is enabled.
...
(fn EVENT)" t) (autoload 'xref-mouse-mode "xref" "Minor mode to bind Xref commands invoked using the mouse.
...
(fn &optional ARG)" t) (put 'global-xref-mouse-mode 'globalized-minor-mode t) (defvar global-xref-mouse-mode nil "Non-nil if Global Xref-Mouse mode is enabled.
See the `global-xref-mouse-mode' command
for a description of this minor mode.
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `global-xref-mouse-mode'.") (custom-autoload 'global-xref-mouse-mode "xref" nil) (autoload 'global-xref-mouse-mode "xref" "Toggle Xref-Mouse mode in all buffers.
With prefix ARG, enable Global Xref-Mouse mode if ARG is positive; otherwise,
disable it.
...
Xref-Mouse mode is enabled in all buffers where `xref-mouse-mode' would do it.

See `xref-mouse-mode' for more information on Xref-Mouse mode.

(fn &optional ARG)" t) (autoload 'xref-find-apropos "xref" "Find all meaningful symbols that match PATTERN.
...
(fn REGEXP FILES DIR IGNORES &optional DELIMITED)") (autoload 'xref-matches-in-files "xref" "Find all matches for REGEXP in FILES.
Return a list of xref values.
...
(fn REGEXP FILES)") (register-definition-prefixes "xref" '("xref-")) (provide 'xref-autoloads)) "project" ((project project-autoloads project-pkg) (autoload 'project-current "project" "Return the project instance in DIRECTORY, defaulting to `default-directory'.
...
(fn &optional INCLUDE-ALL)" t) (autoload 'project-find-matching-buffer "project" "Switch to a matching buffer in another project.
...
directory under the target project to preempt this prompting." t) (autoload 'project-find-dir "project" "Start Dired in a directory inside the current project.

The current buffer's `default-directory' is available as part of
\"future history\"." t) (autoload 'project-dired "project" "Start Dired in the current project's root." t) (autoload 'project-vc-dir "project" "Run VC-Dir in the current project's root." t) (autoload 'project-customize-dirlocals "project" "Run `customize-dirlocals' in current project's root." t) (autoload 'project-shell "project" "Start an inferior shell in the current project's root directory.
If a buffer already exists for running a shell in the project's root,
switch to it.  Otherwise, create a new shell buffer.
With \\[universal-argument] prefix arg, create a new inferior shell buffer even
if one already exists.
With numeric prefix arg, switch to the session with that number, or
create it if it doesn't already exist." t) (autoload 'project-eshell "project" "Start Eshell in the current project's root directory.
If a buffer already exists for running Eshell in the project's root,
switch to it.  Otherwise, create a new Eshell buffer.
With \\[universal-argument] prefix arg, create a new Eshell buffer even
if one already exists.
With numeric prefix arg, switch to the session with that number, or
create it if it doesn't already exist." t) (autoload 'project-async-shell-command "project" "Run `async-shell-command' in the current project's root directory." t) (function-put 'project-async-shell-command 'interactive-only 'async-shell-command) (autoload 'project-shell-command "project" "Run `shell-command' in the current project's root directory." t) (function-put 'project-shell-command 'interactive-only 'shell-command) (autoload 'project-search "project" "Search for REGEXP in all the files of the project.
...
(fn &optional NO-CONFIRM PROJECT)" t) (autoload 'project-save-some-buffers "project" "Like `save-some-buffers', but only for this project's buffers.

(fn ARG)" t) (autoload 'project-remember-project "project" "Add project PR to the front of the project list.
...
(fn PR &optional NO-WRITE STABLE)" t) (autoload 'project-forget-project "project" "Remove directory PROJECT-ROOT from the project list.
...
value is `non-remote', show the project name only for local files.") (custom-autoload 'project-mode-line "project" t) (register-definition-prefixes "project" '("project-" "vc-")) (provide 'project-autoloads)) "flymake" ((flymake-pkg flymake flymake-autoloads) (autoload 'flymake-log "flymake" "Log, at level LEVEL, the message MSG formatted with ARGS.
...
(fn LOCUS BEG END TYPE INFO &optional DATA OVERLAY-PROPERTIES)") (autoload 'flymake-diagnostics "flymake" "Get Flymake diagnostics in region determined by BEG and END.
...
(fn &optional ARG)" t) (autoload 'flymake-mode-on "flymake" "Turn Flymake mode on.") (autoload 'flymake-mode-off "flymake" "Turn Flymake mode off.") (register-definition-prefixes "flymake" '("flymake-")) (provide 'flymake-autoloads)) "jsonrpc" ((jsonrpc-pkg jsonrpc-autoloads jsonrpc) (register-definition-prefixes "jsonrpc" '("jsonrpc-")) (provide 'jsonrpc-autoloads)) "eglot" ((eglot eglot-autoloads eglot-pkg) (define-obsolete-function-alias 'eglot-update #'eglot-upgrade-eglot "29.1") (autoload 'eglot "eglot" "Start LSP server for PROJECT's buffers under MANAGED-MAJOR-MODES.
...
needed.") (autoload 'eglot-manual "eglot" "Read Eglot's manual." t) (autoload 'eglot-upgrade-eglot "eglot" "Update Eglot to latest version.

(fn &rest _)" t) (put 'eglot-workspace-configuration 'safe-local-variable (lambda (v) (and (listp v) (not (functionp v))))) (put 'eglot--debbugs-or-github-bug-uri 'bug-reference-url-format t) (defun eglot--debbugs-or-github-bug-uri nil (format (if (string= (match-string 2) "github") "https://github.com/joaotavora/eglot/issues/%s" "https://debbugs.gnu.org/%s") (match-string 3))) (register-definition-prefixes "eglot" '("eglot-")) (provide 'eglot-autoloads)) "flycheck" ((flycheck flycheck-buttercup flycheck-autoloads) (autoload 'flycheck-manual "flycheck" "Open the Flycheck manual." t) (autoload 'flycheck-quick-help "flycheck" "Display brief Flycheck help." t) (autoload 'flycheck-mode "flycheck" "Flycheck is a minor mode for on-the-fly syntax checking.
...
(fn SYMBOL CHECKER &optional FILE-NAME &rest CUSTOM-ARGS)" nil t) (function-put 'flycheck-def-config-file-var 'lisp-indent-function 3) (autoload 'flycheck-def-option-var "flycheck" "Define SYMBOL as option variable with INIT-VALUE for CHECKERS.
...
(fn COMMAND &optional ARG &rest IGNORE)" t) (register-definition-prefixes "company-yasnippet" '("company-yasnippet-")) (provide 'company-autoloads)) "avy" ((avy-autoloads avy) (autoload 'avy-process "avy" "Select one of CANDIDATES using `avy-read'.
...
(fn &rest CMD)") (register-definition-prefixes "pfuture" '("pfuture-")) (provide 'pfuture-autoloads)) "lv" ((lv-autoloads lv) (register-definition-prefixes "lv" '("lv-")) (provide 'lv-autoloads)) "hydra" ((hydra-examples hydra hydra-ox hydra-autoloads) (autoload 'defhydra "hydra" "Create a Hydra - a family of functions with prefix NAME.
...
(fn PROMPT &optional INITIAL-INPUT)") (register-definition-prefixes "cfrs" '("cfrs-")) (provide 'cfrs-autoloads)) "treemacs" ((treemacs-project-follow-mode treemacs treemacs-core-utils treemacs-extensions treemacs-visuals treemacs-tags treemacs-scope treemacs-workspaces treemacs-mouse-interface treemacs-header-line treemacs-fringe-indicator treemacs-async treemacs-treelib treemacs-interface treemacs-icons treemacs-rendering treemacs-peek-mode treemacs-bookmarks treemacs-customization treemacs-faces treemacs-git-commit-diff-mode treemacs-themes treemacs-autoloads treemacs-compatibility treemacs-tag-follow-mode treemacs-file-management treemacs-hydras treemacs-mode treemacs-filewatch-mode treemacs-logging treemacs-annotations treemacs-dom treemacs-persistence treemacs-follow-mode treemacs-macros) (autoload 'treemacs-version "treemacs" "Return the `treemacs-version'." t) (autoload 'treemacs "treemacs" "Initialise or toggle treemacs.
...
(fn &optional ARG FAMILY)" t) (register-definition-prefixes "all-the-icons" '("all-the-icons-")) (provide 'all-the-icons-autoloads)) "awesome-tab" ((awesome-tab awesome-tab-autoloads) (autoload 'awesome-tab-backward "awesome-tab" "Select the previous available tab.
Depend on the setting of the option `awesome-tab-cycle-scope'." t) (autoload 'awesome-tab-forward "awesome-tab" "Select the next available tab.
Depend on the setting of the option `awesome-tab-cycle-scope'." t) (autoload 'awesome-tab-backward-group "awesome-tab" "Go to selected tab in the previous available group." t) (autoload 'awesome-tab-forward-group "awesome-tab" "Go to selected tab in the next available group." t) (autoload 'awesome-tab-backward-tab "awesome-tab" "Select the previous visible tab." t) (autoload 'awesome-tab-forward-tab "awesome-tab" "Select the next visible tab." t) (defvar awesome-tab-mode nil "Non-nil if Awesome-Tab mode is enabled.
See the `awesome-tab-mode' command
for a description of this minor mode.
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `awesome-tab-mode'.") (custom-autoload 'awesome-tab-mode "awesome-tab" nil) (autoload 'awesome-tab-mode "awesome-tab" "Toggle display of a tab bar in the header line.
With prefix argument ARG, turn on if positive, otherwise off.
Returns non-nil if the new state is enabled.

\\{awesome-tab-mode-map}

(fn &optional ARG)" t) (autoload 'awesome-tab-counsel-switch-group "awesome-tab" "Switch group of awesome-tab." t) (register-definition-prefixes "awesome-tab" '("awesome" "helm-source-awesome-tab-group")) (provide 'awesome-tab-autoloads)) "scroll-restore" ((scroll-restore-pkg scroll-restore scroll-restore-autoloads) (defvar scroll-restore-mode nil "Non-nil if Scroll-Restore mode is enabled.
See the `scroll-restore-mode' command
for a description of this minor mode.
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `scroll-restore-mode'.") (custom-autoload 'scroll-restore-mode "scroll-restore" nil) (autoload 'scroll-restore-mode "scroll-restore" "Toggle Scroll Restore mode.
...
(fn &optional ARG)" t) (register-definition-prefixes "scroll-restore" '("scroll-restore-")) (provide 'scroll-restore-autoloads))))

#s(hash-table test eq data (org-elpa #s(hash-table test equal data (version (16 "https://github.com/emacs-straight/org-mode.git") "use-package" nil "bind-key" nil "exec-path-from-shell" nil "general" nil "cl-lib" nil "which-key" nil "catppuccin-theme" nil "doom-modeline" nil "compat" nil "nerd-icons" nil "shrink-path" nil "s" nil "dash" nil "f" nil "nyan-mode" nil "evil" nil "goto-chg" nil "evil-collection" nil "annalist" nil "evil-nerd-commenter" nil "projectile" nil "magit" nil "cond-let" nil "llama" nil "magit-section" nil "seq" nil "transient" nil "with-editor" nil "diff-hl" nil "vterm" nil "vterm-toggle" nil "rg" nil "wgrep" nil "gcmh" nil "eglot" nil "eldoc" nil "external-completion" nil "flymake" nil "project" nil "xref" nil "jsonrpc" nil "flycheck" nil "treesit-auto" nil "ivy" nil "company" nil "posframe" nil "treemacs" nil "ace-window" nil "avy" nil "pfuture" nil "hydra" nil "lv" nil "ht" nil "cfrs" nil "treemacs-projectile" nil "dashboard" nil "all-the-icons" nil "awesome-tab" nil "scroll-restore" nil)) melpa #s(hash-table test equal data (version 3 "use-package" nil "bind-key" nil "exec-path-from-shell" (exec-path-from-shell :type git :host github :repo "purcell/exec-path-from-shell") "general" (general :type git :host github :repo "noctuid/general.el") "cl-lib" nil "which-key" (which-key :type git :host github :repo "justbur/emacs-which-key") "catppuccin-theme" (catppuccin-theme :type git :host github :repo "catppuccin/emacs") "doom-modeline" (doom-modeline :type git :host github :repo "seagle0128/doom-modeline") "compat" nil "nerd-icons" (nerd-icons :type git :files (:defaults "data" "nerd-icons-pkg.el") :host github :repo "rainstormstudio/nerd-icons.el") "shrink-path" (shrink-path :type git :host gitlab :repo "bennya/shrink-path.el") "s" (s :type git :host github :repo "magnars/s.el") "dash" (dash :type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "f" (f :type git :host github :repo "rejeep/f.el") "nyan-mode" (nyan-mode :type git :files ("nyan-mode.el" "img" "mus" "nyan-mode-pkg.el") :host github :repo "TeMPOraL/nyan-mode") "evil" (evil :type git :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil") "goto-chg" (goto-chg :type git :host github :repo "emacs-evil/goto-chg") "evil-collection" (evil-collection :type git :files (:defaults "modes" "evil-collection-pkg.el") :host github :repo "emacs-evil/evil-collection") "annalist" (annalist :type git :host github :repo "noctuid/annalist.el") "evil-nerd-commenter" (evil-nerd-commenter :type git :host github :repo "redguardtoo/evil-nerd-commenter") "projectile" (projectile :type git :host github :repo "bbatsov/projectile") "magit" (magit :type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" ("git-hooks" "git-hooks/*") (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit") "cond-let" (cond-let :type git :host github :repo "tarsius/cond-let") "llama" (llama :type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama") "magit-section" (magit-section :type git :files ("lisp/magit-section.el" "docs/magit-section.texi" "magit-section-pkg.el" "magit-section-pkg.el") :host github :repo "magit/magit") "seq" nil "transient" (transient :type git :host github :repo "magit/transient") "with-editor" (with-editor :type git :host github :repo "magit/with-editor") "diff-hl" (diff-hl :type git :host github :repo "dgutov/diff-hl") "vterm" (vterm :type git :files ("CMakeLists.txt" "elisp.c" "elisp.h" "emacs-module.h" "etc" "utf8.c" "utf8.h" "vterm.el" "vterm-module.c" "vterm-module.h" "vterm-pkg.el") :host github :repo "akermu/emacs-libvterm") "vterm-toggle" (vterm-toggle :type git :host github :repo "jixiuf/vterm-toggle") "rg" (rg :type git :host github :repo "dajva/rg.el") "wgrep" (wgrep :type git :files ("wgrep.el" "wgrep-pkg.el") :host github :repo "mhayashi1120/Emacs-wgrep") "gcmh" (gcmh :type git :host gitlab :repo "koral/gcmh") "eglot" nil "eldoc" nil "external-completion" nil "flymake" nil "project" nil "xref" nil "jsonrpc" nil "flycheck" (flycheck :type git :host github :repo "flycheck/flycheck") "treesit-auto" (treesit-auto :type git :host github :repo "renzmann/treesit-auto") "ivy" (ivy :type git :files (:defaults "doc/ivy-help.org" (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "ivy-pkg.el") :host github :repo "abo-abo/swiper") "company" (company :type git :files (:defaults "icons" ("images/small" "doc/images/small/*.png") "company-pkg.el") :host github :repo "company-mode/company-mode") "posframe" (posframe :type git :host github :repo "tumashu/posframe") "treemacs" (treemacs :type git :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs") "ace-window" (ace-window :type git :host github :repo "abo-abo/ace-window") "avy" (avy :type git :host github :repo "abo-abo/avy") "pfuture" (pfuture :type git :host github :repo "Alexander-Miller/pfuture") "hydra" (hydra :type git :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra") "lv" (lv :type git :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra") "ht" (ht :type git :host github :repo "Wilfred/ht.el") "cfrs" (cfrs :type git :host github :repo "Alexander-Miller/cfrs") "treemacs-projectile" (treemacs-projectile :type git :files ("src/extra/treemacs-projectile.el" "treemacs-projectile-pkg.el") :host github :repo "Alexander-Miller/treemacs") "dashboard" (dashboard :type git :files (:defaults "banners" "dashboard-pkg.el") :host github :repo "emacs-dashboard/dashboard") "all-the-icons" (all-the-icons :type git :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el") "awesome-tab" nil "scroll-restore" nil)) gnu-elpa-mirror #s(hash-table test equal data (version 3 "use-package" (use-package :type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git"))) "bind-key" (bind-key :type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git"))) "cl-lib" nil "compat" (compat :type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git"))) "seq" (seq :type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git"))) "eglot" (eglot :type git :host github :repo "emacs-straight/eglot" :files ("*" (:exclude ".git"))) "eldoc" (eldoc :type git :host github :repo "emacs-straight/eldoc" :files ("*" (:exclude ".git"))) "external-completion" (external-completion :type git :host github :repo "emacs-straight/external-completion" :files ("*" (:exclude ".git"))) "flymake" (flymake :type git :host github :repo "emacs-straight/flymake" :files ("*" (:exclude ".git"))) "project" (project :type git :host github :repo "emacs-straight/project" :files ("*" (:exclude ".git"))) "xref" (xref :type git :host github :repo "emacs-straight/xref" :files ("*" (:exclude ".git"))) "jsonrpc" (jsonrpc :type git :host github :repo "emacs-straight/jsonrpc" :files ("*" (:exclude ".git"))) "awesome-tab" nil "scroll-restore" (scroll-restore :type git :host github :repo "emacs-straight/scroll-restore" :files ("*" (:exclude ".git"))))) nongnu-elpa #s(hash-table test equal data (version (5 "https://github.com/emacsmirror/nongnu_elpa.git") "cl-lib" nil "awesome-tab" nil)) el-get #s(hash-table test equal data (version 2 "cl-lib" nil "awesome-tab" nil)) emacsmirror-mirror #s(hash-table test equal data (version 2 "cl-lib" nil "awesome-tab" (awesome-tab :type git :host github :repo "emacsmirror/awesome-tab")))))

("scroll-restore" "awesome-tab" "all-the-icons" "dashboard" "treemacs-projectile" "cfrs" "ht" "lv" "hydra" "pfuture" "avy" "ace-window" "treemacs" "posframe" "company" "ivy" "treesit-auto" "flycheck" "python" "jsonrpc" "xref" "project" "flymake" "external-completion" "eldoc" "eglot" "gcmh" "wgrep" "rg" "vterm-toggle" "vterm" "diff-hl" "with-editor" "transient" "seq" "magit-section" "llama" "cond-let" "magit" "projectile" "evil-nerd-commenter" "annalist" "evil-collection" "nadvice" "goto-chg" "evil" "nyan-mode" "f" "s" "shrink-path" "nerd-icons" "compat" "doom-modeline" "catppuccin-theme" "which-key" "cl-lib" "general" "exec-path-from-shell" "dash" "bind-key" "use-package" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa" "emacs" "straight")
